base = "PYTHONPATH=../../ python ../nvll.py --cuda --lr 10.0 --batch_size 50 " \
       "--eval_batch_size 50 --log_interval 300 --model nvrnn --epochs 70  " \
       "--optim sgd --data_name yelp --data_path data/yelp --clip 0.25 " \
       "--input_z --dropout 0.5 --emsize 100 --nhid 400 --aux_weight 0.0001 " \
       "--lat_dim 32 --mix_unk 0 --nlayers 1 --swap 0.0 --replace 0.0  " \
       "--exp_path /backup2/jcxu/exp-nvrnn --mix_unk 1 --root_path /home/jcxu/vae_txt  "
# RNNLM(zero), nor, vMF
